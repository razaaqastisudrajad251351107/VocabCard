                ...
                <div class="p-6">
                    <form action="{{ route('categories.update', $category->id) }}" method="POST">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" name="nama_kategori" id="nama_kategori" value="{{ $category->nama_kategori }}" required class="w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-blue-500 focus:ring-blue-500 rounded-md shadow-sm">
                        </div>
