            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-md sm:rounded-lg border border-gray-300 dark:border-gray-700">
                ...
                <div class="px-6 py-5 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900/50 text-center">
                    ...
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                        Silakan masukkan data history baru di bawah ini.
                    </p>
                </div>
                ...
                <div class="p-6">
                    <form action="{{ route('histories.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <select name="user_id" id="user_id" required class="w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-blue-500 focus:ring-blue-500 rounded-md shadow-sm">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="score" id="score" required class="w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-blue-500 focus:ring-blue-500 rounded-md shadow-sm">
                        </div>

                        <div class="mb-6">
                            <label for="total_question" class="block font-medium text-sm text-gray-700 dark:text-gray-300 mb-2">Total Question</label>
                            <input type="number" name="total_question" id="total_question" required class="w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-blue-500 focus:ring-blue-500 rounded-md shadow-sm">
                        </div>
