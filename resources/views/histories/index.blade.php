                    ...
                    <table class="w-full border-collapse border border-gray-300 dark:border-gray-700">
                        <thead>
                            <tr class="bg-gray-100 dark:bg-gray-700">
                                ...
                                <th class="border border-gray-300 dark:border-gray-600 p-2 text-left">Score</th>
                                <th class="border border-gray-300 dark:border-gray-600 p-2 text-left">Total Question</th>
                                <th class="border border-gray-300 dark:border-gray-600 p-2 text-center">Aksi</th>
                            </tr>
                        </thead>
